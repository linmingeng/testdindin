...
$sql = "SELECT `appid`,`name`,`ver`,`typeid`,`mobile_appid`,`mobile_appsecret`,`mobile_mchid`,`mobile_mchkey`,`mobile_sslcert`,`mobile_sslkey` FROM `the_app_sets` WHERE ".$whereStr." AND `flag` = 1 ";
$ret = $db->getX($sql);
