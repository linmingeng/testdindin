...
class fileSystem {
                        ...
                        foreach ($condition as $name => $value)    {
                            switch ($name) {
                                case 'fileext':
                                    ...
                                    if ($fileext_list) {
                                        $valid = in_array($this->fileExt($file), $fileext_list);
                                    }
                                    break;
                                case 'fileonly':
                                ...
                                case 'filename':
                                    if ($value) {
                                        $valid = ( $value == basename($file, $this->fileExt($file, true)) );
                                    }
                                    break;
                            }
                            if (!valid) {
    ...
    function fileList($path, $fileext='', $sort='ASC', $withPath=false) {
        ...
        $result = $this->ls($path, $condition, $sort, $withPath);
        return $result;
    }
