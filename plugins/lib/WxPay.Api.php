...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetAppid(getConf('APPID'));//公众账号ID
		$inputObj->SetMch_id(getConf('MCHID'));//商户号
	...
	{		
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT, getConf('SSLCERT_PATH'));
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, getConf('SSLKEY_PATH'));
		}
		//post提交方式
