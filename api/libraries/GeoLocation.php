<?php
//github: https://github.com/anthonymartin/GeoLocation.php
/**
...
$coordinates = $edison->boundingCoordinates(0.05, 'km');

echo '<br>';
echo "Point: " . $lng.",".$lat . " \n";
echo '<br>';
echo "Point latitude: " . $lat . " \n";
echo '<br>';
echo "Point longitude: " . $lng . " \n";
echo '<br>';
echo '<br>';
...
$min = GeoLocation::fromDegrees($min_lat, $min_lng);
$max = GeoLocation::fromDegrees($max_lat, $max_lng);

echo '<br>';
echo "Distance from Point to min: " . 
$point->distanceTo($min, 'km') . " km \n";
echo '<br>';
echo "Distance from Point to max: " . 
$point->distanceTo($max, 'km') . " km \n";
*/ 