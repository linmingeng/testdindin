     ...
     <!--  <p class="margin-b">如果您已经有帐户，请点击登录 <a href="http://velikorodnov.com/opencart/shopme/demo6/index.php?route=account/login">login page</a>.</p> -->
      <div class="row form-item" style="padding-top: 50px;">
	      ...
	      <div class="col-md-4 col-lg-4 col-sm-5 col-xs-7 pull-right1 rights">
	      	  <div class="row register-title"><h3 class="col-md-4 col-lg-4 col-sm-4 col-xs-4">欢迎注册</h3><div class="pull-right">我已经注册？<a href="?/user/login" style="color:#809a2d">直接登录</a></div></div>
...
<!--			        </div> -->
		        ...
		        <div class="form-group">
			        	<div class="code">
			        		<input type="text" onkeyup="value=value.replace(/[\W]/g,'') " onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[\W]/g,''))" name="phoneCode" id="phoneCode" maxlength="4" id="authcode" placeholder="请输入验证码" class="form-control"/>
				        	<div class="error-message">
				        		<span>验证码不能为空！</span><i></i>
				        	</div>
			        	</div>
